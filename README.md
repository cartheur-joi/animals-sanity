...
### Emotional detection of the user

* `Design a program to mathematically represent moods within an ops domain.` [14M2]
* `Have that program leverage common tools to analyze audio`
